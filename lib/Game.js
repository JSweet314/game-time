...
module.exports = class Game {
  ...
  determineClosestFiringBase(xTarget, yTarget) {
    ...
    // **************** POSSIBLE SCENARIOS **************** //
    // xTarget <= 500 / 3 && leftBase.numberOfMissiles > 0 // left click, left base has missiles
    // xTarget <= 500 / 3 && midBase.numberOfMissiles > 0 // left click, mid base has missiles, left none
    // xTarget <= 500 / 3 && rightBase.numberOfMissiles > 0 // left click, right base has missiles, left and mid none

    // xTarget > 500 / 3 && xTarget < 1000 / 3 && midBase.numberOfMissiles > 0 // mid click, mid base has missiles
    // xTarget <= 250 && leftBase.numberOfMissiles > 0 // left-half click, left has missiles
    // xTarget > 250 && rightBase.numberOfMissiles > 0 // right-half click, right hase missiles

    // xTarget >= 1000 / 3 && rightBase.numberOfMissiles > 0 // right click, right has missiles
    // xTarget >= 1000 / 3 && midBase.numberOfMissiles > 0 // right click, mid has missiles
    // xTarget >= 1000 / 3 && leftBase.numberOfMissiles > 0 // right click, left has missiles
